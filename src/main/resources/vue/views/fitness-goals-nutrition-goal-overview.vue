<template id="fitness-goals-nutrition-goal-overview">
  <app-layout>
    <div class="mt-4">
      <h5>Nutrition Goals List</h5>
      <ul>
...
<script>
  app.component("fitness-goals-nutrition-goal-overview",{
  template: "#fitness-goals-nutrition-goal-overview",
  data: () => ({
  nutritionGoals: [],
}),
  created() {
