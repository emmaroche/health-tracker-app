...
//        }
    ...
    private fun retrieveGoalByType(type : String) : HttpResponse<String> {
        return Unirest.get(origin + "/api/users/weightGoals/${type}").asString()
    }
    ...
    private fun updateWeightGoal(
        ...
        val startingWeightTimestampStr = startingWeightTimestamp.toString(ISODateTimeFormat.dateTime())  // Format as ISO 8601
    ...
    private fun addWeightGoal(
        type: String, startingWeight: Double, startingWeightTimestamp: DateTime, currentWeight: Double, targetWeight: Double, weeklyGoal: Double, deadline: DateTime, userId: Int
    ): HttpResponse<JsonNode> {
